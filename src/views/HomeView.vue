...
onMounted(() => {
  ...
  nodeCane.setScope(globalScope)
  nodeOne.setScope(globalScope)
  nodeVariable.setScope(globalScope)
  nodeVariable2.setScope(globalScope)

  nodeEditorStore.setGlobalScope(globalScope.id)
})
