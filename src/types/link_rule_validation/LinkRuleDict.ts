...
export const getLinkRuleDict = (nodeEditorStore: any): LinkRuleValidationDict[] => {
  ...
  const linkRuleValidationDict: LinkRuleValidationDict[] = [
    ...
    {
      message: 'Not same interface type',
      successfulRules: [VariableMutabilityConstant.getInstance()],
      OnSuccessfulRules: (
        sourceInterface: InterfaceComponent,
        targetInterface: InterfaceComponent,
        rules: LinkRule[]
        ...
        console.log('[SUCCESS] VariableMutabilityConstant')
      },
      failedRules: [VariableMutabilityConstant.getInstance()],
      OnFailedRules: (
        sourceInterface: InterfaceComponent,
        targetInterface: InterfaceComponent,
        rules: LinkRule[]
        ...
        console.log('[FAILURE] VariableMutabilityConstant')
      }
    }
  ]
